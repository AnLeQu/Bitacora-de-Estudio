#Operaciones entre conjuntos: #se pueden modificar, no tiene un orden y no se pueden duplicar
#############################################################################################
...
print('-' * 10)
#############################################################################################
#SYMMETRIC DIFFERENCE: Muestra los elementos externos removiendo los datos en común, del lado izq.
